...
namespace DrSavviAPI.Models
{
    ...
    public partial class DrSavvyEntities : DbContext
    {
        ...
        public virtual int AddMobileApp(string appDate, string startTime, string endTime, string patientName, string patientSurname, string appDescr, Nullable<int> appID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddMobileApp", appDateParameter, startTimeParameter, endTimeParameter, patientNameParameter, patientSurnameParameter, appDescrParameter, appIDParameter);
        }
